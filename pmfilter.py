...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # Create the buttons based on the JS_WEB_PREMIUM and has_premium flags
       ...
       await log_msg.reply_text(
        ...
        buttons = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ʜᴇʀᴇ', user_id=int(821215952))
        ],[
    ...
    #-x
        ...
        buttons = [[
            InlineKeyboardButton('☆📸 𝙎𝙚𝙣𝙙 𝙨𝙘𝙧𝙚𝙚𝙣𝙨𝙝𝙤𝙩 📸☆', url=f'https://t.me/MrXeonTG')
        ],[
...
#-x
    ...
    #jisshu 
        ...
        buttons = [[
            InlineKeyboardButton('☎️ 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘄𝗻𝗲𝗿 𝗧𝗼 𝗞𝗻𝗼𝘄 𝗠𝗼𝗿𝗲', user_id=int(821215952))
        ],[
